...
type
  TdmgDV = class(TDataModule)
    ...
    cdsTempDataDIInterpretation: TWideStringField;
    cdsTempDataDIAge: TFloatField;
    cdsTempDataDISuitName: TWideStringField;
    cdsTempDataDIInterpAbr: TWideStringField;
    cdsTempDataDIGrouping: TWideStringField;
    ...
    cdsTempDataDTGrouping: TWideStringField;
    cdsTempDataDTSuitName: TWideStringField;
    ...
    cdsTempDataDTIsoSystem: TWideStringField;
    cdsTempDataDTMaterialAbr: TWideStringField;
    cdsTempDataDTApproachAbr: TWideStringField;
    cdsTempDataDTBlockingT: TFloatField;
    cdsTempDataDTBlockingTUncertainty: TFloatField;
    cdsTempDataDGGrouping: TWideStringField;
    cdsTempDataDGAge: TFloatField;
    cdsTempDataDGSuitName: TWideStringField;
    cdsTempDataDGInterpAbr: TWideStringField;
    cdsTempDataDGInterpretation: TWideStringField;
    ...
    QdmGroupingGROUPING: TWideStringField;
    ...
    QdmSmpCONTINENTID: TWideStringField;
    QdmSmpCOUNTRYABR: TWideStringField;
    ...
    QdmOrogenicPeriodOROGENICPERIODID: TWideStringField;
    QdmChemTypeRECORDID: TIntegerField;
    QdmChemTypeCHEMTYPEABR: TWideStringField;
    QdmBoundaryRECORDID: TIntegerField;
    QdmBoundaryBOUNDARYID: TIntegerField;
    QdmBoundaryBOUNDPOSID: TWideStringField;
    ...
    QdmBlockingTMATERIALABR: TWideStringField;
    QdmBlockingTISOSYSTEM: TWideStringField;
    QdmBlockingTAPPROACHABR: TWideStringField;
    ...
    cdsQdmGroupingGROUPING: TWideStringField;
    ...
    cdsQdmSmpCONTINENTID: TWideStringField;
    cdsQdmSmpCOUNTRYABR: TWideStringField;
    ...
    cdsQdmOrogenicPeriodOROGENICPERIODID: TWideStringField;
    cdsQdmChemTypeRECORDID: TIntegerField;
    cdsQdmChemTypeCHEMTYPEABR: TWideStringField;
    cdsQdmBoundaryRECORDID: TIntegerField;
    cdsQdmBoundaryBOUNDARYID: TIntegerField;
    cdsQdmBoundaryBOUNDPOSID: TWideStringField;
    ...
    cdsQdmBlockingTMATERIALABR: TWideStringField;
    cdsQdmBlockingTISOSYSTEM: TWideStringField;
    cdsQdmBlockingTAPPROACHABR: TWideStringField;
    ...
    cdsTempDataIInterpretation: TWideStringField;
    ...
    cdsTempDataIGrouping: TWideStringField;
    ...
    cdsGroupingLinkGROUPINGLINK: TWideStringField;
    cdsGroupingLinkUSERID: TWideStringField;
    QuerydmDI: TSQLQuery;
    ...
    cdsQuerydmDGGROUPINGLINK: TWideStringField;
    cdsQuerydmDGRAGE: TFloatField;
    cdsQuerydmDGUNITNAME: TWideStringField;
    cdsQuerydmDGINTERPABR: TWideStringField;
    ...
    cdsQuerydmDTGROUPINGLINK: TWideStringField;
    cdsQuerydmDTUNITNAME: TWideStringField;
    ...
    cdsQuerydmDTISOTOPESYSTEM: TWideStringField;
    cdsQuerydmDTMATERIALABR: TWideStringField;
    cdsQuerydmDTAPPROACHABR: TWideStringField;
    cdsQuerydmDTINTERPABR: TWideStringField;
    ...
    cdsQuerydmMISAMPLENO: TWideStringField;
    cdsQuerydmMILATITUDE: TFloatField;
    cdsQuerydmMILONGITUDE: TFloatField;
    cdsQuerydmMIINTERPABR: TWideStringField;
    cdsQuerydmMIOPTIONTITLE: TWideStringField;
    cdsQuerydmMIRAGE: TFloatField;
    cdsQuerydmIRAGE: TFloatField;
    cdsQuerydmIUNITNAME: TWideStringField;
    cdsQuerydmIINTERPABR: TWideStringField;
    ...
    cdsQuerydmDIOPTIONTITLE: TWideStringField;
    cdsQuerydmDIRAGE: TFloatField;
    cdsQuerydmDIUNITNAME: TWideStringField;
    cdsQuerydmDIINTERPABR: TWideStringField;
    cdsQuerydmDIOPTIONID: TIntegerField;
    cdsQuerydmDIRAGEPERROR: TFloatField;
    cdsQuerydmDIRAGEMERROR: TFloatField;
    cdsQuerydmIOPTIONTITLE: TWideStringField;
    ...
    cdsQuerydmIGGROUPINGLINK: TWideStringField;
    cdsQuerydmIGRAGE: TFloatField;
    cdsQuerydmIGUNITNAME: TWideStringField;
    cdsQuerydmIGINTERPABR: TWideStringField;
    ...
    cdsQuerydmMIGSAMPLENO: TWideStringField;
    cdsQuerydmMIGLATITUDE: TFloatField;
    cdsQuerydmMIGLONGITUDE: TFloatField;
    cdsQuerydmMIGINTERPABR: TWideStringField;
    cdsQuerydmMIGGROUPINGLINK: TWideStringField;
    ...
    QuerydmDIOPTIONTITLE: TWideStringField;
    QuerydmDIRAGE: TFloatField;
    QuerydmDIUNITID: TIntegerField;
    QuerydmDIUNITNAME: TWideStringField;
    QuerydmDIINTERPABR: TWideStringField;
    QuerydmDIOPTIONTITLE_1: TWideStringField;
    ...
    cdsTempDataMapInterpretation: TWideStringField;
    cdsTempDataMapAgeBand: TWideStringField;
    cdsTempDataMapInterpAbr: TWideStringField;
    cdsTempDataMapColumnNo: TIntegerField;
    cdsTempDataMapSampleNo: TWideStringField;
