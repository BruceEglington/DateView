...
type
  TdmDV = class(TDataModule)
    ...
    qCountriesCOUNTRYABR: TWideStringField;
    qCountriesCOUNTRY: TWideStringField;
    qCountriesCOUNTRYOFFSET: TFloatField;
    qCountriesCOUNTRYOFFSET2: TFloatField;
    qCountriesCOUNTRYOFFSET3: TFloatField;
    qCountriesCONTINENTID: TWideStringField;
    qCountriesCONTINENT: TWideStringField;
    dspCountries: TDataSetProvider;
    cdsCountries: TClientDataSet;
    cdsCountriesCOUNTRYABR: TWideStringField;
    ...
    qUnits: TSQLQuery;
    qUnitsUNITNAME: TWideStringField;
    qUnitsUNITRANK: TWideStringField;
    ...
    cdsUnitsUNITRANK: TWideStringField;
    ...
    qLithol: TSQLQuery;
    qLitholLITHOLOGY: TWideStringField;
    dspLithol: TDataSetProvider;
    cdsLithol: TClientDataSet;
    cdsLitholLITHOLOGY: TWideStringField;
    qInterpretations: TSQLQuery;
    qInterpretationsINTERPABR: TWideStringField;
    qInterpretationsINTERPRETATION: TWideStringField;
    dspInterpretations: TDataSetProvider;
    cdsInterpretations: TClientDataSet;
    cdsInterpretationsINTERPABR: TWideStringField;
    cdsInterpretationsINTERPRETATION: TWideStringField;
    qReferences: TSQLQuery;
    dspReferences: TDataSetProvider;
    cdsReferences: TClientDataSet;
    qAgeUnits: TSQLQuery;
    qAgeUnitsAGEUNITS: TWideStringField;
    dspAgeUnits: TDataSetProvider;
    cdsAgeUnits: TClientDataSet;
    cdsAgeUnitsAGEUNITS: TWideStringField;
    qApproach: TSQLQuery;
    qApproachAPPROACHABR: TWideStringField;
    qApproachAPPROACHDESCRIPTION: TWideStringField;
    dspApproach: TDataSetProvider;
    cdsApproach: TClientDataSet;
    cdsApproachAPPROACHABR: TWideStringField;
    cdsApproachAPPROACHDESCRIPTION: TWideStringField;
    qTechniques: TSQLQuery;
    qTechniquesTECHABR: TWideStringField;
    qTechniquesTECHNIQUE: TWideStringField;
    dspTechniques: TDataSetProvider;
    cdsTechniques: TClientDataSet;
    cdsTechniquesTECHABR: TWideStringField;
    cdsTechniquesTECHNIQUE: TWideStringField;
    qIsoSystems: TSQLQuery;
    qIsoSystemsISOSYSTEM: TWideStringField;
    qIsoSystemsISOSYSTEMNAME: TWideStringField;
    ...
    cdsIsoSystemsISOSYSTEM: TWideStringField;
    cdsIsoSystemsISOSYSTEMNAME: TWideStringField;
    ...
    qMaterial: TSQLQuery;
    qMaterialMATERIALABR: TWideStringField;
    qMaterialMATERIALDESCRIPTION: TWideStringField;
    dspMaterial: TDataSetProvider;
    cdsMaterial: TClientDataSet;
    cdsMaterialMATERIALABR: TWideStringField;
    cdsMaterialMATERIALDESCRIPTION: TWideStringField;
    qWhoFor: TSQLQuery;
    qWhoForWHOFORID: TWideStringField;
    qWhoForWHOFOR: TWideStringField;
    ...
    qBoundariesBOUNDARYNAME: TWideStringField;
    dspBoundaries: TDataSetProvider;
    cdsBoundaries: TClientDataSet;
    cdsBoundariesBOUNDARYID: TIntegerField;
    cdsBoundariesBOUNDARYNAME: TWideStringField;
    qBoundaryPositions: TSQLQuery;
    qBoundaryPositionsBOUNDPOSID: TWideStringField;
    qBoundaryPositionsBOUNDARYPOSITION: TWideStringField;
    dspBoundaryPositions: TDataSetProvider;
    cdsBoundaryPositions: TClientDataSet;
    cdsBoundaryPositionsBOUNDPOSID: TWideStringField;
    cdsBoundaryPositionsBOUNDARYPOSITION: TWideStringField;
    qRefTypes: TSQLQuery;
    qRefTypesSOURCETYPEID: TWideStringField;
    qRefTypesSOURCETYPE: TWideStringField;
    dspRefTypes: TDataSetProvider;
    cdsRefTypes: TClientDataSet;
    cdsRefTypesSOURCETYPEID: TWideStringField;
    cdsRefTypesSOURCETYPE: TWideStringField;
    qMethods: TSQLQuery;
    qMethodsMETHODABR: TWideStringField;
    qMethodsMETHODNAME: TWideStringField;
    dspMethods: TDataSetProvider;
    cdsMethods: TClientDataSet;
    cdsMethodsMETHODABR: TWideStringField;
    cdsMethodsMETHODNAME: TWideStringField;
    qRefDetail: TSQLQuery;
    dspRefDetail: TDataSetProvider;
    cdsRefDetail: TClientDataSet;
    qOrogenicPeriods: TSQLQuery;
    qOrogenicPeriodsOROGENICPERIODID: TWideStringField;
    qOrogenicPeriodsOROGENICPERIOD: TWideStringField;
    dspOrogenicPeriods: TDataSetProvider;
    cdsOrogenicPeriods: TClientDataSet;
    cdsOrogenicPeriodsOROGENICPERIODID: TWideStringField;
    cdsOrogenicPeriodsOROGENICPERIOD: TWideStringField;
    qChemTypes: TSQLQuery;
    qChemTypesCHEMTYPEABR: TWideStringField;
    qChemTypesCHEMICALTYPE: TWideStringField;
    dspChemTypes: TDataSetProvider;
    cdsChemTypes: TClientDataSet;
    cdsChemTypesCHEMTYPEABR: TWideStringField;
    cdsChemTypesCHEMICALTYPE: TWideStringField;
    qTerranes: TSQLQuery;
    ...
    qGroupingListGROUPING: TWideStringField;
    dspGroupingList: TDataSetProvider;
    cdsGroupingList: TClientDataSet;
    cdsGroupingListGROUPING: TWideStringField;
    qAreaDetail: TSQLQuery;
    qAreaDetailCOUNTRYABR: TWideStringField;
    qAreaDetailCOUNTRY: TWideStringField;
    qAreaDetailCOUNTRYOFFSET: TFloatField;
    qAreaDetailCOUNTRYOFFSET2: TFloatField;
    qAreaDetailCOUNTRYOFFSET3: TFloatField;
    qAreaDetailCONTINENTID: TWideStringField;
    dspAreaDetail: TDataSetProvider;
    cdsAreaDetail: TClientDataSet;
    cdsAreaDetailCOUNTRYABR: TWideStringField;
    cdsAreaDetailCOUNTRY: TWideStringField;
    cdsAreaDetailCOUNTRYOFFSET: TFloatField;
    cdsAreaDetailCOUNTRYOFFSET2: TFloatField;
    cdsAreaDetailCOUNTRYOFFSET3: TFloatField;
    cdsAreaDetailCONTINENTID: TWideStringField;
    qImageTypes: TSQLQuery;
    qImageTypesIMAGETYPEID: TWideStringField;
    qImageTypesIMAGETYPE: TWideStringField;
    dspImageTypes: TDataSetProvider;
    cdsImageTypes: TClientDataSet;
    cdsImageTypesIMAGETYPEID: TWideStringField;
    cdsImageTypesIMAGETYPE: TWideStringField;
    ...
    qSmpRegDetailsISOSYSTEM: TWideStringField;
    qSmpRegDetailsSAMPLENO: TWideStringField;
    qSmpRegDetailsFRAC: TWideStringField;
    qSmpRegDetailsINCLUDED: TWideStringField;
    dspSmpRegDetails: TDataSetProvider;
    cdsSmpRegDetails: TClientDataSet;
    cdsSmpRegDetailsRECORDID: TIntegerField;
    cdsSmpRegDetailsISOSYSTEM: TWideStringField;
    cdsSmpRegDetailsSAMPLENO: TWideStringField;
    cdsSmpRegDetailsFRAC: TWideStringField;
    cdsSmpRegDetailsINCLUDED: TWideStringField;
    qImageDetails: TSQLQuery;
    qImageDetailsRECORDID: TIntegerField;
    qImageDetailsIMAGETYPEID: TWideStringField;
    qImageDetailsIMAGEID: TIntegerField;
    qImageDetailsIMAGECAPTION: TBlobField;
    ...
    cdsImageDetailsIMAGETYPEID: TWideStringField;
    cdsImageDetailsIMAGEID: TIntegerField;
    cdsImageDetailsIMAGECAPTION: TBlobField;
    ...
    qUnitCountryCOUNTRYABR: TWideStringField;
    cdsUnitCountryUNITNAME: TWideStringField;
    cdsUnitCountryCOUNTRYABR: TWideStringField;
    qUnitArea: TSQLQuery;
    dspUnitArea: TDataSetProvider;
    cdsUnitArea: TClientDataSet;
    dsUnitArea: TDataSource;
    qUnitAreaCOUNTRYABR: TWideStringField;
    cdsUnitAreaCOUNTRYABR: TWideStringField;
    qGroupingListUSERID: TWideStringField;
    qGroupingListEXPIRYDATE: TSQLTimeStampField;
    cdsGroupingListUSERID: TWideStringField;
    ...
    cdsLaboratoriesLABORATORYABR: TWideStringField;
    cdsLaboratoriesLABORATORYNAME: TWideStringField;
    qYesNo: TSQLQuery;
    ...
    cdsClosureTemperaturesMATERIALABR: TWideStringField;
    cdsClosureTemperaturesISOSYSTEM: TWideStringField;
    cdsClosureTemperaturesAPPROACHABR: TWideStringField;
    cdsClosureTemperaturesBLOCKINGT: TFloatField;
    cdsClosureTemperaturesBLOCKINGTUNCERTAINTY: TFloatField;
    cdsClosureTemperaturesMATERIALDESCRIPTION: TWideStringField;
    cdsClosureTemperaturesISOSYSTEMNAME: TWideStringField;
    cdsClosureTemperaturesAPPROACHDESCRIPTION: TWideStringField;
    SQLQuery3: TSQLQuery;
    ...
    cdsResultsCOUNTRYABR: TWideStringField;
    cdsResultsUNITNAME: TWideStringField;
    cdsResultsMATERIALABR: TWideStringField;
    cdsResultsISOTOPESYSTEM: TWideStringField;
    cdsResultsAPPROACHABR: TWideStringField;
    cdsResultsTECHABR: TWideStringField;
    cdsResultsINTERPABR: TWideStringField;
    ...
    cdsResultsAGEUNITS: TWideStringField;
    cdsResultsCONFIDENTIAL: TIntegerField;
    cdsResultsLITHOLOGY: TWideStringField;
    cdsResultsMETHODABR: TWideStringField;
    ...
    cdsResults2COUNTRYABR: TWideStringField;
    cdsResults2MATERIALABR: TWideStringField;
    cdsResults2ISOTOPESYSTEM: TWideStringField;
    cdsResults2APPROACHABR: TWideStringField;
    cdsResults2TECHABR: TWideStringField;
    cdsResults2INTERPABR: TWideStringField;
    cdsResults2PREFLEVEL: TSmallintField;
    cdsResults2AGEUNITS: TWideStringField;
    cdsResults2LITHOLOGY: TWideStringField;
    cdsResults2METHODABR: TWideStringField;
    ...
    cdsResultsExtraREGISTEREDUSER: TWideStringField;
    ...
    cdsIsoInitMODEL: TWideStringField;
    ...
    cdsIsoOtherWEIGHTING: TWideStringField;
    cdsIsoRefRECORDID: TIntegerField;
    cdsIsoRefSOURCETYPEID: TWideStringField;
    cdsIsoRefSOURCETYPE: TWideStringField;
    cdsIsoValidRECORDID: TIntegerField;
    cdsIsoValidVALIDSTATUSID: TWideStringField;
    cdsIsoValidDATEDONE: TSQLTimeStampField;
    cdsIsoValidDONEBY: TWideStringField;
    cdsIsoValidCOMMENTS: TBlobField;
    cdsIsoValidVALIDATIONSTATUS: TWideStringField;
    cdsIsoLabRECORDID: TIntegerField;
    cdsIsoLabLABORATORYABR: TWideStringField;
    cdsIsoLabLABORATORYNAME: TWideStringField;
    cdsIsoValid2RECORDID: TIntegerField;
    cdsIsoValid2VALIDSTATUSID: TWideStringField;
    cdsIsoValid2DATEDONE: TSQLTimeStampField;
    cdsIsoValid2DONEBY: TWideStringField;
    cdsIsoValid2COMMENTS: TBlobField;
    cdsIsoGroupingRECORDID: TIntegerField;
    cdsIsoGroupingGROUPING: TWideStringField;
    cdsIsoOrogenicRECORDID: TIntegerField;
    cdsIsoOrogenicOROGENICPERIODID: TWideStringField;
    cdsIsoOrogenicOROGENICPERIOD: TWideStringField;
    cdsIsoChemTypeRECORDID: TIntegerField;
    cdsIsoChemTypeCHEMTYPEABR: TWideStringField;
    cdsIsoChemTypeCHEMICALTYPE: TWideStringField;
    ...
    cdsIsoBoundaryBOUNDPOSID: TWideStringField;
    cdsIsoBoundaryBOUNDARYNAME: TWideStringField;
    cdsIsoBoundaryBOUNDARYPOSITION: TWideStringField;
    cdsSmpRegRECORDID: TIntegerField;
    cdsSmpRegSAMPLENO: TWideStringField;
    cdsSmpRegFRAC: TWideStringField;
    cdsSmpRegINCLUDED: TWideStringField;
    cdsSmpRegISOSYSTEM: TWideStringField;
    ...
    cdsIsoImagesIMAGETYPEID: TWideStringField;
    cdsIsoImagesIMAGEID: TIntegerField;
    cdsIsoImagesIMAGETYPE: TWideStringField;
    ...
    qResultsMATERIALABR: TWideStringField;
    qResultsISOTOPESYSTEM: TWideStringField;
    qResultsAPPROACHABR: TWideStringField;
    qResultsTECHABR: TWideStringField;
    qResultsINTERPABR: TWideStringField;
    ...
    qResultsAGEUNITS: TWideStringField;
    qResultsCONFIDENTIAL: TIntegerField;
    qResultsLITHOLOGY: TWideStringField;
    qResultsMETHODABR: TWideStringField;
    qResultsRECORDID: TIntegerField;
    qResultsRAGE: TFloatField;
    qResultsRAGEPERROR: TFloatField;
    qResultsRAGEMERROR: TFloatField;
    qResults2COUNTRYABR: TWideStringField;
    qResults2MATERIALABR: TWideStringField;
    qResults2ISOTOPESYSTEM: TWideStringField;
    qResults2APPROACHABR: TWideStringField;
    qResults2TECHABR: TWideStringField;
    qResults2INTERPABR: TWideStringField;
    qResults2PREFLEVEL: TSmallintField;
    qResults2AGEUNITS: TWideStringField;
    qResults2LITHOLOGY: TWideStringField;
    qResults2METHODABR: TWideStringField;
    ...
    qSmpRegSAMPLENO: TWideStringField;
    qSmpRegFRAC: TWideStringField;
    qSmpRegINCLUDED: TWideStringField;
    qSmpRegISOSYSTEM: TWideStringField;
    ...
    qIsoBoundaryBOUNDPOSID: TWideStringField;
    qIsoBoundaryBOUNDARYNAME: TWideStringField;
    qIsoBoundaryBOUNDARYPOSITION: TWideStringField;
    qIsoRefRECORDID: TIntegerField;
    qIsoRefSOURCETYPEID: TWideStringField;
    qIsoRefSOURCETYPE: TWideStringField;
    qIsoLabRECORDID: TIntegerField;
    qIsoLabLABORATORYABR: TWideStringField;
    qIsoLabLABORATORYNAME: TWideStringField;
    qIsoValidRECORDID: TIntegerField;
    qIsoValidVALIDSTATUSID: TWideStringField;
    qIsoValidDATEDONE: TSQLTimeStampField;
    qIsoValidDONEBY: TWideStringField;
    qIsoValidCOMMENTS: TBlobField;
    qIsoValidVALIDATIONSTATUS: TWideStringField;
    ...
    qIsoForWHOFORID: TWideStringField;
    qIsoForWHOFOR: TWideStringField;
    Query1Rec: TSQLQuery;
    ...
    cdsUnitRanksUNITRANKID: TWideStringField;
    ...
    qUsersContributedUSERID: TWideStringField;
    qUsersContributedNUMCONTRIBUTED: TIntegerField;
    cdsUsersContributedUSERID: TWideStringField;
    cdsUsersContributedNUMCONTRIBUTED: TIntegerField;
    qIsoChemTypeRECORDID: TIntegerField;
    qIsoChemTypeCHEMTYPEABR: TWideStringField;
    qIsoChemTypeCHEMTYPEABR_1: TWideStringField;
    qIsoChemTypeCHEMICALTYPE: TWideStringField;
    qIsoOrogenicRECORDID: TIntegerField;
    qIsoOrogenicOROGENICPERIODID: TWideStringField;
    qIsoOrogenicOROGENICPERIOD: TWideStringField;
    qIsoGroupingRECORDID: TIntegerField;
    qIsoGroupingGROUPING: TWideStringField;
    qLIPs: TSQLQuery;
    ...
    qUnitAreaUNITNAME: TWideStringField;
    cdsUnitAreaUNITNAME: TWideStringField;
    ...
    cdsProvinceDOMAINNAME: TWideStringField;
    cdsProvinceCONTINENTID: TWideStringField;
    cdsProvinceDOMAINTYPEID: TWideStringField;
    cdsTerraneRECORDID: TIntegerField;
    cdsTerraneDOMAINID: TIntegerField;
    cdsTerraneDOMAINNAME: TWideStringField;
    cdsTerraneCONTINENTID: TWideStringField;
    cdsTerraneDOMAINTYPEID: TWideStringField;
    cdsTerraneDOMAINTYPE: TWideStringField;
    cdsTerraneDOMAINTYPELEVEL: TIntegerField;
    cdsProvinceDOMAINTYPE: TWideStringField;
    ...
    qIsoRefSOURCESHORT: TWideStringField;
    qIsoRefSOURCEDESCRIPTION: TBlobField;
    cdsProvinceNUMRECORDSLINKED: TIntegerField;
    cdsTerraneNUMRECORDSLINKED: TIntegerField;
    cdsIsoRefSOURCESHORT: TWideStringField;
    cdsIsoRefSOURCEDESCRIPTION: TBlobField;
    ...
    cdsRefDetailSOURCEDESCRIPTION: TBlobField;
    qRefNewSOURCESHORT: TWideStringField;
    qIsoValid2RECORDID: TIntegerField;
    qIsoValid2VALIDSTATUSID: TWideStringField;
    qIsoValid2DATEDONE: TSQLTimeStampField;
    qIsoValid2DONEBY: TWideStringField;
    qIsoValid2COMMENTS: TBlobField;
    qProvinceRECORDID: TIntegerField;
    qProvinceDOMAINID: TIntegerField;
    qProvinceCONTINENTID: TWideStringField;
    qProvinceDOMAINNAME: TWideStringField;
    qProvinceDOMAINTYPEID: TWideStringField;
    qProvinceNUMRECORDSLINKED: TIntegerField;
    qProvinceDOMAINTYPE: TWideStringField;
    qProvinceDOMAINTYPELEVEL: TIntegerField;
    qTerraneRECORDID: TIntegerField;
    qTerraneDOMAINID: TIntegerField;
    qTerraneCONTINENTID: TWideStringField;
    qTerraneDOMAINNAME: TWideStringField;
    qTerraneDOMAINTYPEID: TWideStringField;
    qTerraneNUMRECORDSLINKED: TIntegerField;
    qTerraneDOMAINTYPE: TWideStringField;
    ...
    cdsQuerySamplesCONTINENTID: TWideStringField;
    cdsQuerySamplesCOUNTRYABR: TWideStringField;
    cdsQuerySamplesSAMPLENO: TWideStringField;
    cdsQuerySamplesFRAC: TWideStringField;
    cdsQuerySamplesORIGINALNO: TWideStringField;
    cdsQuerySamplesINCLUDED: TWideStringField;
    ...
    cdsThisUnitCountryCOUNTRYABR: TWideStringField;
    cdsThisUnitCountryUNITHASRECORDS: TWideStringField;
    QueryInit: TSQLQuery;
    dspQueryInit: TDataSetProvider;
    cdsQueryInit: TClientDataSet;
    dsQueryInit: TDataSource;
    cdsQueryInitCOUNTRYABR: TWideStringField;
    cdsQueryInitUNITID: TIntegerField;
    cdsQueryInitMATERIALABR: TWideStringField;
    cdsQueryInitISOTOPESYSTEM: TWideStringField;
    cdsQueryInitAPPROACHABR: TWideStringField;
    cdsQueryInitTECHABR: TWideStringField;
    cdsQueryInitINTERPABR: TWideStringField;
    cdsQueryInitPREFLEVEL: TSmallintField;
    cdsQueryInitAGEUNITS: TWideStringField;
    cdsQueryInitCONFIDENTIAL: TIntegerField;
    cdsQueryInitLITHOLOGY: TWideStringField;
    cdsQueryInitMETHODABR: TWideStringField;
    cdsQueryInitRECORDID: TIntegerField;
    cdsQueryInitCOUNTRY: TWideStringField;
    cdsQueryInitMATERIALDESCRIPTION: TWideStringField;
    cdsQueryInitINTERPRETATION: TWideStringField;
    cdsQueryInitAPPROACHDESCRIPTION: TWideStringField;
    cdsQueryInitTECHNIQUE: TWideStringField;
    cdsQueryInitISOSYSTEMNAME: TWideStringField;
    cdsQueryInitRAGE: TFloatField;
    cdsQueryInitRAGEPERROR: TFloatField;
    cdsQueryInitRAGEMERROR: TFloatField;
    cdsQueryInitSOURCESHORT: TWideStringField;
    cdsQueryInitUNITNAME: TWideStringField;
    ...
    qSameSampleResultsINTERPABR: TWideStringField;
    qSameSampleResultsPREFLEVEL: TSmallintField;
    qSameSampleResultsMATERIALABR: TWideStringField;
    qSameSampleResultsISOTOPESYSTEM: TWideStringField;
    qSameSampleResultsAPPROACHABR: TWideStringField;
    qSameSampleResultsRAGE: TFloatField;
    qSameSampleResultsRAGEPERROR: TFloatField;
    qSameSampleResultsRAGEMERROR: TFloatField;
    qSameSampleResultsAGEUNITS: TWideStringField;
    cdsSameSampleResultsRECORDID: TIntegerField;
    cdsSameSampleResultsINTERPABR: TWideStringField;
    cdsSameSampleResultsPREFLEVEL: TSmallintField;
    cdsSameSampleResultsMATERIALABR: TWideStringField;
    cdsSameSampleResultsISOTOPESYSTEM: TWideStringField;
    cdsSameSampleResultsAPPROACHABR: TWideStringField;
    ...
    cdsLitholLITHGROUP: TWideStringField;
    qSmpRegLITHOLOGY: TWideStringField;
    qSmpRegIGSN: TWideStringField;
    cdsSmpRegLITHOLOGY: TWideStringField;
    cdsSmpRegIGSN: TWideStringField;
    QueryCombined: TSQLQuery;
    dspQueryCombined: TDataSetProvider;
    cdsQueryCombined: TClientDataSet;
    dsQueryCombined: TDataSource;
    QueryCombinedCOUNTRYABR: TWideStringField;
    QueryCombinedUNITID: TIntegerField;
    QueryCombinedMATERIALABR: TWideStringField;
    QueryCombinedISOTOPESYSTEM: TWideStringField;
    QueryCombinedAPPROACHABR: TWideStringField;
    QueryCombinedTECHABR: TWideStringField;
    QueryCombinedINTERPABR: TWideStringField;
    QueryCombinedPREFLEVEL: TSmallintField;
    QueryCombinedAGEUNITS: TWideStringField;
    QueryCombinedLITHOLOGY: TWideStringField;
    QueryCombinedMETHODABR: TWideStringField;
    QueryCombinedRECORDID: TIntegerField;
    QueryCombinedCOUNTRY: TWideStringField;
    QueryCombinedMATERIALDESCRIPTION: TWideStringField;
    QueryCombinedINTERPRETATION: TWideStringField;
    QueryCombinedAPPROACHDESCRIPTION: TWideStringField;
    QueryCombinedTECHNIQUE: TWideStringField;
    QueryCombinedISOSYSTEMNAME: TWideStringField;
    QueryCombinedRAGE: TFloatField;
    QueryCombinedRAGEPERROR: TFloatField;
    QueryCombinedRAGEMERROR: TFloatField;
    QueryCombinedSOURCESHORT: TWideStringField;
    QueryCombinedUNITNAME: TWideStringField;
    QueryCombinedREFNUM: TIntegerField;
    QueryCombinedWHOFORID: TWideStringField;
    QueryCombinedSAMPLENO: TWideStringField;
    QueryCombinedFRAC: TWideStringField;
    QueryCombinedLONGITUDE: TFloatField;
    QueryCombinedLATITUDE: TFloatField;
    QueryCombinedELEVATION: TFloatField;
    QueryCombinedINCLUDED: TWideStringField;
    cdsQueryCombinedCOUNTRYABR: TWideStringField;
    cdsQueryCombinedUNITID: TIntegerField;
    cdsQueryCombinedMATERIALABR: TWideStringField;
    cdsQueryCombinedISOTOPESYSTEM: TWideStringField;
    cdsQueryCombinedAPPROACHABR: TWideStringField;
    cdsQueryCombinedTECHABR: TWideStringField;
    cdsQueryCombinedINTERPABR: TWideStringField;
    cdsQueryCombinedPREFLEVEL: TSmallintField;
    cdsQueryCombinedAGEUNITS: TWideStringField;
    cdsQueryCombinedLITHOLOGY: TWideStringField;
    cdsQueryCombinedMETHODABR: TWideStringField;
    cdsQueryCombinedRECORDID: TIntegerField;
    cdsQueryCombinedCOUNTRY: TWideStringField;
    cdsQueryCombinedMATERIALDESCRIPTION: TWideStringField;
    cdsQueryCombinedINTERPRETATION: TWideStringField;
    cdsQueryCombinedAPPROACHDESCRIPTION: TWideStringField;
    cdsQueryCombinedTECHNIQUE: TWideStringField;
    cdsQueryCombinedISOSYSTEMNAME: TWideStringField;
    cdsQueryCombinedRAGE: TFloatField;
    cdsQueryCombinedRAGEPERROR: TFloatField;
    cdsQueryCombinedRAGEMERROR: TFloatField;
    cdsQueryCombinedSOURCESHORT: TWideStringField;
    cdsQueryCombinedUNITNAME: TWideStringField;
    cdsQueryCombinedREFNUM: TIntegerField;
    cdsQueryCombinedWHOFORID: TWideStringField;
    cdsQueryCombinedSAMPLENO: TWideStringField;
    cdsQueryCombinedFRAC: TWideStringField;
    cdsQueryCombinedLONGITUDE: TFloatField;
    cdsQueryCombinedLATITUDE: TFloatField;
    cdsQueryCombinedELEVATION: TFloatField;
    cdsQueryCombinedINCLUDED: TWideStringField;
    qCheckUsersOwnRecord: TSQLQuery;
    cdsCheckUsersOwnRecord: TClientDataSet;
    dsCheckUsersOwnRecord: TDataSource;
    dspCheckUsersOwnRecord: TDataSetProvider;
    qCheckUsersOwnRecordRECORDID: TIntegerField;
    qCheckUsersOwnRecordVALIDSTATUSID: TWideStringField;
    qCheckUsersOwnRecordDONEBY: TWideStringField;
    cdsCheckUsersOwnRecordRECORDID: TIntegerField;
    cdsCheckUsersOwnRecordVALIDSTATUSID: TWideStringField;
    cdsCheckUsersOwnRecordDONEBY: TWideStringField;
    cdsRecordIDsqResults2: TDataSetField;
    cdsRecordIDsqResults: TDataSetField;
    qResultsRAGEPERRORTRACER: TFloatField;
    qResultsRAGEMERRORTRACER: TFloatField;
    qResultsRAGEPERRORALL: TFloatField;
    qResultsRAGEMERRORALL: TFloatField;
    qResults2RAGEPERRORTRACER: TFloatField;
    qResults2RAGEMERRORTRACER: TFloatField;
    qResults2RAGEPERRORALL: TFloatField;
    qResults2RAGEMERRORALL: TFloatField;
    cdsResults2RAGEPERRORTRACER: TFloatField;
    cdsResults2RAGEMERRORTRACER: TFloatField;
    cdsResults2RAGEPERRORALL: TFloatField;
    cdsResults2RAGEMERRORALL: TFloatField;
    qResultsExtraRECORDID: TIntegerField;
    qResultsExtraDECAYCONST1: TFloatField;
    qResultsExtraDECAYCONST2: TFloatField;
    qResultsExtraSIGMAPERCENTDC1: TFloatField;
    qResultsExtraSIGMAPERCENTDC2: TFloatField;
    qResultsExtraDATESTRING: TSQLTimeStampField;
    qResultsExtraREGISTEREDUSER: TWideStringField;
    qResultsExtraISOTOPECONSTANT: TFloatField;
    cdsRecordIDsqResultsExtra: TDataSetField;
    cdsResultsExtraISOTOPECONSTANT: TFloatField;
    cdsClosureTemperaturesCLOSTMPASSOCID: TWideStringField;
    ...
    qClosTmpAssoc: TSQLQuery;
    dspClosTmpAssoc: TDataSetProvider;
    cdsClosTmpAssoc: TClientDataSet;
    dsClosTmpAssoc: TDataSource;
    cdsClosTmpAssocCLOSTMPASSOCID: TWideStringField;
    cdsPrefLevelsPREFLEVELNO: TSmallintField;
    cdsPrefLevelsPREFSHORT: TWideStringField;
    cdsPrefLevelsPREFDES: TBlobField;
    qReconModels: TSQLQuery;
    dspReconModels: TDataSetProvider;
    cdsReconModels: TClientDataSet;
    dsReconModels: TDataSource;
    cdsReconModelsRCNMDLID: TWideStringField;
    cdsReconModelsRECONMODEL: TWideStringField;
    qGDUs: TSQLQuery;
    ...
    cdsGDUsGDUCONCATENATION: TWideStringField;
    qTerranesDOMAINNAME: TWideStringField;
    qTerranesCONTINENTID: TWideStringField;
    qTerranesDOMAINID: TIntegerField;
    qTerranesDOMAINTYPEID: TWideStringField;
    ...
    Query1COUNTRYABR: TWideStringField;
    Query1UNITID: TIntegerField;
    Query1MATERIALABR: TWideStringField;
    Query1ISOTOPESYSTEM: TWideStringField;
    Query1APPROACHABR: TWideStringField;
    Query1TECHABR: TWideStringField;
    Query1INTERPABR: TWideStringField;
    Query1PREFLEVEL: TSmallintField;
    Query1AGEUNITS: TWideStringField;
    Query1LITHOLOGY: TWideStringField;
    Query1METHODABR: TWideStringField;
    Query1RECORDID: TIntegerField;
    Query1COUNTRY: TWideStringField;
    Query1MATERIALDESCRIPTION: TWideStringField;
    Query1INTERPRETATION: TWideStringField;
    Query1APPROACHDESCRIPTION: TWideStringField;
    Query1TECHNIQUE: TWideStringField;
    Query1ISOSYSTEMNAME: TWideStringField;
    Query1RAGE: TFloatField;
    Query1RAGEPERROR: TFloatField;
    Query1RAGEMERROR: TFloatField;
    Query1SOURCESHORT: TWideStringField;
    Query1UNITNAME: TWideStringField;
    Query1REFNUM: TIntegerField;
    Query1WHOFORID: TWideStringField;
    cdsQuery1COUNTRYABR: TWideStringField;
    cdsQuery1UNITID: TIntegerField;
    cdsQuery1MATERIALABR: TWideStringField;
    cdsQuery1ISOTOPESYSTEM: TWideStringField;
    cdsQuery1APPROACHABR: TWideStringField;
    cdsQuery1TECHABR: TWideStringField;
    cdsQuery1INTERPABR: TWideStringField;
    cdsQuery1PREFLEVEL: TSmallintField;
    cdsQuery1AGEUNITS: TWideStringField;
    cdsQuery1LITHOLOGY: TWideStringField;
    cdsQuery1METHODABR: TWideStringField;
    cdsQuery1RECORDID: TIntegerField;
    cdsQuery1COUNTRY: TWideStringField;
    cdsQuery1MATERIALDESCRIPTION: TWideStringField;
    cdsQuery1INTERPRETATION: TWideStringField;
    cdsQuery1APPROACHDESCRIPTION: TWideStringField;
    cdsQuery1TECHNIQUE: TWideStringField;
    cdsQuery1ISOSYSTEMNAME: TWideStringField;
    cdsQuery1RAGE: TFloatField;
    cdsQuery1RAGEPERROR: TFloatField;
    cdsQuery1RAGEMERROR: TFloatField;
    cdsQuery1SOURCESHORT: TWideStringField;
...
begin
  ...
  //dmUser.SetDeveloperData('after dmDVSubmitQuery1 dmUser.SetFormData2');
end;
...
begin
  ...
  //dmUser.SetDeveloperData('After dmDV.QueryCombined parambyname');
end;
...
//    Query1Rec.SQL.Add('      TECHNIQUE,ISOSYSTEM,SUITE,USERSWHOFOR,ISOFOR,SOURCEA,SOURCELIST');
  ...
  tmpStringList.Clear;
    ...
    begin
      //dmUser.SetDeveloperData('in ConstructQueryStringList. TerraneCount = '+IntToStr(UserSession.TerraneValues.Count));
      //dmUser.SetDeveloperData('in ConstructQueryStringList ***'+UserSession.TerraneValues[0]);
      tmpStringList.Add('AND ');
      ...
      begin
        ...
        begin
          //dmUser.SetDeveloperData('in ConstructQueryStringList ***'+UserSession.TerraneValues[i-1]);
          tmpStringList.Add('OR ');
...
begin
  ...
  dmDV.qClosureTemperatures.SQL.Add('  APPROACH.APPROACHDESCRIPTION, BLOCKINGT.CLOSTMPASSOCID');
