...
type
  TdmDV = class(TDataModule)
    ...
    qCheckUsersOwnRecordVALIDSTATUSID: TStringField;
    qCheckUsersOwnRecordDONEBY: TStringField;
    cdsCheckUsersOwnRecordRECORDID: TIntegerField;
    cdsCheckUsersOwnRecordVALIDSTATUSID: TStringField;
    cdsCheckUsersOwnRecordDONEBY: TStringField;
