object ISFNewRawRecord: TISFNewRawRecord
  Left = 0
  Top = 0
  Width = 1560
  Height = 1500
  ...
  object iwrRight: TIWRegion
    ...
    Align = alClient
    BorderOptions.Style = cbsNone
    object iwrNewDetails: TIWRegion
      Left = 0
      Top = 0
      Width = 1487
      Height = 544
      ...
      object iwbResetUnits: TIWButton
        Left = 920
        Top = 45
        Width = 57
        Height = 30
        ...
        Font.Size = 10
        Font.Style = []
        FriendlyName = 'iwbResetUnits'
        TabOrder = 22
        OnClick = iwbResetUnitsClick
      end
    end
