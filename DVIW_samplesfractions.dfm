object ISFSamplesFractions: TISFSamplesFractions
  Left = 0
  Top = 0
  Width = 900
  Height = 600
  ...
  object iwDBgSamplesFractions: TIWDBGrid
    ...
    Columns = <
      item
        ...
        DataField = 'SAMPLENO'
        LinkField = 'SAMPLENO'
        OnClick = iwDBgSamplesFractionsColumns0Click
      ...
      item
        ...
        CompareHighlight = hcNone
        DataField = 'FRAC'
        OnClick = iwDBgSamplesFractionsColumns1Click
        Title.Alignment = taCenter
        Title.BGColor = clNone
        Title.DoSubmitValidation = True
        Title.Font.Color = clNone
    ...
    DataSource = dmDV.dsSmpFracRange
    FooterRowCount = 0
    FriendlyName = 'iwDBgSamplesFractions'
    FromStart = False
  ...
  object iwbAddNewSample: TIWButton
    ...
    Width = 217
    Height = 25
    Caption = 'Add new fraction to current sample'
  ...
  object iwDBnSamplesFractions: TIWDBNavigator
    ...
    DataSource = dmDV.dsSmpFracRange
    FriendlyName = 'iwDBnSamplesFractions'
    ImageHeight = 24
    ImageWidth = 24
  ...
  object iwdblcbSampleZone: TIWDBLookupComboBox
    ...
    DataField = 'ZONEID'
    DataSource = dmDV.dsSmpFracRange
    FriendlyName = 'iwdblcbSampleZone'
    KeyField = 'ZONEID'
    ListField = 'ZONETYPE'
