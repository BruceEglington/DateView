object ISFOrogenicPeriods: TISFOrogenicPeriods
  Left = 0
  Top = 0
  Width = 693
  Height = 568
  ...
  object iwDBg: TIWDBGrid
    ...
    DataSource = dmDV.dsOrogenicPeriods
    FooterRowCount = 0
    FriendlyName = 'iwDBg'
    FromStart = False
  ...
  object FDMemTable1: TFDMemTable
    ...
    Left = 512
    Top = 64
    object FDMemTable1OrogenicPeriodID: TStringField
      FieldName = 'OrogenicPeriodID'
      Size = 5
    end
    object FDMemTable1OrogenicPeriod: TStringField
