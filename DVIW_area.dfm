object ISFAreas: TISFAreas
  ...
  object iwDBgAreas: TIWDBGrid
    ...
    Columns = <
      ...
      item
        ...
        BlobCharLimit = 0
        CompareHighlight = hcNone
        DataField = 'COUNTRYHASRECORDS'
        Title.Alignment = taCenter
        Title.BGColor = clNone
        Title.DoSubmitValidation = True
        Title.Font.Color = clNone
        Title.Font.FontName = 'Ari'
        Title.Font.Size = 9
        Title.Font.Style = [fsBold]
        Title.Header = False
        Title.Height = '0'
        Title.ShowHint = True
        Title.Text = 'Has records'
        Title.VAlign = vaMiddle
        Title.Visible = True
        Title.Width = '0'
        Title.Wrap = False
  ...
  object FDMemTable1: TFDMemTable
    ...
    Left = 512
    Top = 64
    object FDMemTable1RegionID: TStringField
      FieldName = 'RegionID'
      Size = 3
    end
    ...
    object FDMemTable1COID: TStringField
      FieldName = 'COID'
      Size = 3
    end
    object FDMemTable1RegionOffset: TFloatField
      FieldName = 'RegionOffset'
    end
    object FDMemTable1RegionOffset2: TFloatField
      FieldName = 'RegionOffset2'
    end
    object FDMemTable1RegionOffset3: TFloatField
      FieldName = 'RegionOffset3'
    end
    object FDMemTable1ContOcean: TStringField
      FieldName = 'ContOcean'
    end
    object FDMemTable1RegionHasRecords: TStringField
      FieldName = 'RegionHasRecords'
      Size = 1
    end
  end
end
