object dmDV: TdmDV
  ...
  object qResults: TSQLQuery
    ...
    SQL.Strings = (
      ...
      'ISORGR30.Lithology, ISORGR30.MethodAbr, ISORGR30.RecordID, '
      'ISORGR30.RAGE, ISORGR30.RAGEPERROR, ISORGR30.RAGEMERROR,'
      'ISORGR30.RAGEPERRORTRACER, ISORGR30.RAGEMERRORTRACER,  '
      'ISORGR30.RAGEPERRORALL, ISORGR30.RAGEMERRORALL,  '
      'SUITE.UNITNAME  '
    ...
    object qResultsRAGEPERRORTRACER: TFloatField
      FieldName = 'RAGEPERRORTRACER'
    end
    object qResultsRAGEMERRORTRACER: TFloatField
      FieldName = 'RAGEMERRORTRACER'
    end
    object qResultsRAGEPERRORALL: TFloatField
      FieldName = 'RAGEPERRORALL'
    end
    object qResultsRAGEMERRORALL: TFloatField
      FieldName = 'RAGEMERRORALL'
    end
  end
  ...
  object qResultsExtra: TSQLQuery
    ...
    Left = 496
    Top = 246
    object qResultsExtraRECORDID: TIntegerField
      FieldName = 'RECORDID'
      Required = True
    end
    object qResultsExtraDECAYCONST1: TFloatField
      FieldName = 'DECAYCONST1'
      Required = True
    end
    object qResultsExtraDECAYCONST2: TFloatField
      FieldName = 'DECAYCONST2'
      Required = True
    end
    object qResultsExtraSIGMAPERCENTDC1: TFloatField
      FieldName = 'SIGMAPERCENTDC1'
      Required = True
    end
    object qResultsExtraSIGMAPERCENTDC2: TFloatField
      FieldName = 'SIGMAPERCENTDC2'
      Required = True
    end
    object qResultsExtraDATESTRING: TSQLTimeStampField
      FieldName = 'DATESTRING'
    end
    object qResultsExtraREGISTEREDUSER: TWideStringField
  ...
  object qResults2: TSQLQuery
    ...
    object qResults2RAGEPERRORTRACER: TFloatField
      FieldName = 'RAGEPERRORTRACER'
    end
    object qResults2RAGEMERRORTRACER: TFloatField
      FieldName = 'RAGEMERRORTRACER'
    end
    object qResults2RAGEPERRORALL: TFloatField
      FieldName = 'RAGEPERRORALL'
    end
    object qResults2RAGEMERRORALL: TFloatField
      FieldName = 'RAGEMERRORALL'
    end
  end
  ...
  object cdsResults2: TClientDataSet
    ...
    object cdsResults2RAGEPERRORTRACER: TFloatField
      FieldName = 'RAGEPERRORTRACER'
      DisplayFormat = '###0.00'
    end
    object cdsResults2RAGEMERRORTRACER: TFloatField
      FieldName = 'RAGEMERRORTRACER'
      DisplayFormat = '###0.00'
    end
    object cdsResults2RAGEPERRORALL: TFloatField
      FieldName = 'RAGEPERRORALL'
      DisplayFormat = '###0.00'
    end
    object cdsResults2RAGEMERRORALL: TFloatField
      FieldName = 'RAGEMERRORALL'
      DisplayFormat = '###0.00'
    end
  end
  ...
  object qClosureTemperatures: TSQLQuery
    ...
    SQL.Strings = (
        ...
        '  BlockingT.BlockingT, BlockingT.blockingTUncertainty,BlockingT.' +
        'ClosTmpAssocID,'
  ...
  object cdsClosureTemperatures: TClientDataSet
    ...
    object cdsClosureTemperaturesCLOSTMPASSOCID: TWideStringField
      FieldName = 'CLOSTMPASSOCID'
      Required = True
      FixedChar = True
    end
  end
  ...
  object qNumRecords: TSQLQuery
    ...
    Params = <>
    SQL.Strings = (
      'select first 1 * from NumRecords'
  ...
  object qCheckUsersOwnRecord: TSQLQuery
    ...
    object qCheckUsersOwnRecordVALIDSTATUSID: TWideStringField
      FieldName = 'VALIDSTATUSID'
      Required = True
      Size = 5
    end
    object qCheckUsersOwnRecordDONEBY: TWideStringField
      FieldName = 'DONEBY'
      Required = True
    end
  end
  object cdsCheckUsersOwnRecord: TClientDataSet
    ...
    object cdsCheckUsersOwnRecordVALIDSTATUSID: TWideStringField
      FieldName = 'VALIDSTATUSID'
      Required = True
      Size = 5
    end
    object cdsCheckUsersOwnRecordDONEBY: TWideStringField
      FieldName = 'DONEBY'
      Required = True
    end
  end
  ...
  object qClosTmpAssoc: TSQLQuery
    MaxBlobSize = -1
    Params = <>
    SQL.Strings = (
      'select * from ClosureTempAssoc')
    SQLConnection = sqlcDateView
    Left = 776
    Top = 530
  end
  object dspClosTmpAssoc: TDataSetProvider
    DataSet = qClosTmpAssoc
    Left = 804
    Top = 530
  end
  object cdsClosTmpAssoc: TClientDataSet
    Aggregates = <>
    Params = <>
    ProviderName = 'dspClosTmpAssoc'
    Left = 832
    Top = 530
    object cdsClosTmpAssocCLOSTMPASSOCID: TWideStringField
      FieldName = 'CLOSTMPASSOCID'
      Required = True
      FixedChar = True
    end
  end
  object dsClosTmpAssoc: TDataSource
    DataSet = cdsClosTmpAssoc
    Left = 858
    Top = 530
  end
  object qReconModels: TSQLQuery
    ObjectView = True
    MaxBlobSize = -1
    Params = <>
    SQL.Strings = (
      'select * from ReconModels')
    SQLConnection = sqlcDateView
    Left = 12
    Top = 782
  end
  object dspReconModels: TDataSetProvider
    DataSet = qReconModels
    Left = 42
    Top = 782
  end
  object cdsReconModels: TClientDataSet
    Aggregates = <>
    Params = <>
    ProviderName = 'dspReconModels'
    ReadOnly = True
    Left = 70
    Top = 782
    object cdsReconModelsRCNMDLID: TWideStringField
      FieldName = 'RCNMDLID'
      Required = True
      FixedChar = True
      Size = 10
    end
    object cdsReconModelsRECONMODEL: TWideStringField
      FieldName = 'RECONMODEL'
      Required = True
      FixedChar = True
      Size = 50
    end
  end
  object dsReconModels: TDataSource
    DataSet = cdsReconModels
    Left = 98
    Top = 782
  end
  object qGDUs: TSQLQuery
    ...
    SQL.Strings = (
      'select GDUs.gduid, GDUs.rcnmdlid, '
      '  GDUs.gduid||'#39' - '#39'||gdus.gduname AS GDUconcatenation'
      'from gdus'
      'where GDUs.rcnmdlid = :ReconModel'
      'and GDUs.gduid > 0')
    SQLConnection = sqlcDateView
    Left = 204
    Top = 790
  ...
  object cdsGDUs: TClientDataSet
    ...
    object cdsGDUsGDUCONCATENATION: TWideStringField
      FieldName = 'GDUCONCATENATION'
      FixedChar = True
      Size = 123
    end
  end
