object ISFStandards: TISFStandards
  Left = 0
  Top = 0
  Width = 784
  Height = 549
  ...
  object iwbAddNewStandard: TIWButton
    Left = 472
    Top = 76
    Width = 133
    Height = 25
    Caption = 'Add New Standard'
    Color = clWebLIGHTSKYBLUE
    Font.Color = clNone
    Font.Size = 9
    Font.Style = []
    FriendlyName = 'iwbAddNewStandard'
    TabOrder = 5
    OnClick = iwbAddNewStandardClick
  end
